...
const campusPOIs = [
    ...
    { name: "南区顺丰", category: "驿站", lng: 114.393348, lat: 30.479499,
      desc: "南区顺丰", tags: ["快递", "顺丰"] },
    { name: "北区顺丰", category: "驿站", lng: 114.394574, lat: 30.494637,
      desc: "北区顺丰", tags: ["快递", "顺丰"] },
    { name: "南区京东", category: "驿站", lng: 114.393406, lat: 30.479495,
      desc: "南区京东", tags: ["快递", "京东"] },
    { name: "北区7D快递服务中心", category: "驿站", lng: 114.394543, lat: 30.494639,
      desc: "北区7D快递服务中心", tags: ["快递", "综合"] },
    // ---- 图书馆 ----
    { name: "南区分管", category: "图书馆", lng: 114.392468, lat: 30.48102,
    ...
    { name: "17号教学楼", category: "教学楼", lng: 114.394956, lat: 30.488739,
      desc: "17号教学楼", tags: ["教室"] },
    { name: "中南民族大学光谷音乐厅", category: "教学楼", lng: 114.395284, lat: 30.490433,
      desc: "中南民族大学光谷音乐厅", tags: ["教室"] },
    { name: "中南民族大学光谷美术馆", category: "教学楼", lng: 114.395378, lat: 30.491326,
      desc: "中南民族大学光谷美术馆", tags: ["教室"] },
    ...
    { name: "游泳馆", category: "教学楼", lng: 114.393818, lat: 30.480472,
      desc: "游泳馆", tags: ["游泳"] },
    { name: "保卫处", category: "教学楼", lng: 114.395369, lat: 30.488807,
      desc: "保卫处", tags: ["安全", "保卫"] },
    // ---- 食堂 ----
    ...
    { name: "4食堂", category: "食堂", lng: 114.392245, lat: 30.481202,
      desc: "4食堂", tags: ["餐饮"] },
    { name: "南湖餐厅", category: "食堂", lng: 114.394741, lat: 30.484292,
      desc: "南湖餐厅", tags: ["餐饮"] },
    ...
    { name: "小吃街", category: "食堂", lng: 114.391111, lat: 30.482122,
      desc: "小吃街", tags: ["小吃", "夜宵"] },
    // ---- 打印店 ----
    { name: "科捷图文快印店", category: "打印店", lng: 114.391163, lat: 30.479922,
      desc: "科捷图文快印店", tags: ["打印", "复印"] },
    ...
    { name: "南湖印社", category: "打印店", lng: 114.389758, lat: 30.479498,
      desc: "南湖印社", tags: ["打印", "复印", "印刷"] },
    // ---- 医院 ----
    ...
    { name: "北区药店", category: "医院", lng: 114.396053, lat: 30.49486,
      desc: "北区药店", tags: ["买药"] },
    // ---- 宿舍 ----
    { name: "1栋", category: "宿舍", lng: 114.392518, lat: 30.482639,
      desc: "1栋", tags: ["住宿"] },
    { name: "2栋", category: "宿舍", lng: 114.393302, lat: 30.482514,
      desc: "2栋", tags: ["住宿"] },
    { name: "3栋", category: "宿舍", lng: 114.394007, lat: 30.482517,
      desc: "3栋", tags: ["住宿"] },
    { name: "4栋", category: "宿舍", lng: 114.394899, lat: 30.482487,
      desc: "4栋", tags: ["住宿"] },
    { name: "5栋", category: "宿舍", lng: 114.392348, lat: 30.48222,
      desc: "5栋", tags: ["住宿"] },
    { name: "6栋", category: "宿舍", lng: 114.392444, lat: 30.481941,
      desc: "6栋", tags: ["住宿"] },
    { name: "7栋", category: "宿舍", lng: 114.392974, lat: 30.482206,
      desc: "7栋", tags: ["住宿"] },
    { name: "8栋", category: "宿舍", lng: 114.393606, lat: 30.482166,
      desc: "8栋", tags: ["住宿"] },
    { name: "9栋", category: "宿舍", lng: 114.394159, lat: 30.481901,
      desc: "9栋", tags: ["住宿"] },
    { name: "10栋", category: "宿舍", lng: 114.394817, lat: 30.481885,
      desc: "10栋", tags: ["住宿"] },
    { name: "11栋", category: "宿舍", lng: 114.390596, lat: 30.482656,
      desc: "11栋", tags: ["住宿"] },
    { name: "12栋", category: "宿舍", lng: 114.390533, lat: 30.482475,
      desc: "12栋", tags: ["住宿"] },
    { name: "13栋", category: "宿舍", lng: 114.390471, lat: 30.482043,
      desc: "13栋", tags: ["住宿"] },
    { name: "14栋", category: "宿舍", lng: 114.390471, lat: 30.481753,
      desc: "14栋", tags: ["住宿"] },
    { name: "15栋", category: "宿舍", lng: 114.390463, lat: 30.481411,
      desc: "15栋", tags: ["住宿"] },
    { name: "16栋", category: "宿舍", lng: 114.389657, lat: 30.481714,
      desc: "16栋", tags: ["住宿"] },
    { name: "17栋", category: "宿舍", lng: 114.389644, lat: 30.481336,
      desc: "17栋", tags: ["住宿"] },
    { name: "18栋", category: "宿舍", lng: 114.390932, lat: 30.480899,
      desc: "18栋", tags: ["住宿"] },
    { name: "19栋", category: "宿舍", lng: 114.390949, lat: 30.480537,
      desc: "19栋", tags: ["住宿"] },
    { name: "21栋", category: "宿舍", lng: 114.391048, lat: 30.479815,
      desc: "21栋", tags: ["住宿"] },
    { name: "22栋", category: "宿舍", lng: 114.391036, lat: 30.479506,
      desc: "22栋", tags: ["住宿"] },
    { name: "23栋", category: "宿舍", lng: 114.392173, lat: 30.479528,
      desc: "23栋", tags: ["住宿"] },
    { name: "25栋", category: "宿舍", lng: 114.393228, lat: 30.479493,
      desc: "25栋", tags: ["住宿"] },
    { name: "26栋", category: "宿舍", lng: 114.389952, lat: 30.479478,
      desc: "26栋", tags: ["住宿"] },
    { name: "27栋", category: "宿舍", lng: 114.394041, lat: 30.479526,
      desc: "27栋", tags: ["住宿"] },
    { name: "30栋", category: "宿舍", lng: 114.390598, lat: 30.483262,
      desc: "30栋", tags: ["住宿"] },
    { name: "1A栋", category: "宿舍", lng: 114.396552, lat: 30.49519,
      desc: "1A栋", tags: ["住宿"] },
    { name: "1B栋", category: "宿舍", lng: 114.396585, lat: 30.495415,
      desc: "1B栋", tags: ["住宿"] },
    { name: "2A栋", category: "宿舍", lng: 114.395827, lat: 30.49523,
      desc: "2A栋", tags: ["住宿"] },
    { name: "2B栋", category: "宿舍", lng: 114.395861, lat: 30.495479,
      desc: "2B栋", tags: ["住宿"] },
    { name: "3A栋", category: "宿舍", lng: 114.395236, lat: 30.495338,
      desc: "3A栋", tags: ["住宿"] },
    { name: "3B栋", category: "宿舍", lng: 114.395238, lat: 30.495591,
      desc: "3B栋", tags: ["住宿"] },
    { name: "4A栋", category: "宿舍", lng: 114.394579, lat: 30.49537,
      desc: "4A栋", tags: ["住宿"] },
    { name: "4B栋", category: "宿舍", lng: 114.394597, lat: 30.495655,
      desc: "4B栋", tags: ["住宿"] },
    { name: "5A栋", category: "宿舍", lng: 114.396457, lat: 30.494146,
      desc: "5A栋", tags: ["住宿"] },
    { name: "5B栋", category: "宿舍", lng: 114.396449, lat: 30.493927,
      desc: "5B栋", tags: ["住宿"] },
    { name: "6A栋", category: "宿舍", lng: 114.395754, lat: 30.494233,
      desc: "6A栋", tags: ["住宿"] },
    { name: "6B栋", category: "宿舍", lng: 114.395714, lat: 30.493964,
      desc: "6B栋", tags: ["住宿"] },
    { name: "7A栋", category: "宿舍", lng: 114.395158, lat: 30.494221,
      desc: "7A栋", tags: ["住宿"] },
    { name: "7B栋", category: "宿舍", lng: 114.395124, lat: 30.493995,
      desc: "7B栋", tags: ["住宿"] },
    { name: "8A栋", category: "宿舍", lng: 114.394593, lat: 30.494298,
      desc: "8A栋", tags: ["住宿"] },
    { name: "8B栋", category: "宿舍", lng: 114.394613, lat: 30.494071,
      desc: "8B栋", tags: ["住宿"] },
    { name: "9A栋", category: "宿舍", lng: 114.39403, lat: 30.494346,
      desc: "9A栋", tags: ["住宿"] },
    { name: "9B栋", category: "宿舍", lng: 114.394038, lat: 30.494096,
      desc: "9B栋", tags: ["住宿"] },
    { name: "游泳馆宿舍", category: "宿舍", lng: 114.393565, lat: 30.480953,
      desc: "游泳馆宿舍", tags: ["住宿"] },
    // ---- 其他设施 ----
    { name: "武陵购校园文创", category: "其他设施", lng: 114.389787, lat: 30.47949,
      desc: "武陵购校园文创店", tags: ["文创"] },
    { name: "双塔拾光文创", category: "其他设施", lng: 114.395753, lat: 30.494347,
      desc: "双塔拾光文创店", tags: ["文创"] },
    { name: "发都造型", category: "其他设施", lng: 114.391273, lat: 30.482282,
      desc: "发都造型理发店", tags: ["理发"] },
    { name: "幸运咖", category: "其他设施", lng: 114.392534, lat: 30.48086,
      desc: "幸运咖咖啡店", tags: ["咖啡"] },
    { name: "邮政ATM机", category: "其他设施", lng: 114.390026, lat: 30.479503,
      desc: "邮政ATM机", tags: ["银行"] },
    { name: "中国联通", category: "其他设施", lng: 114.389564, lat: 30.479582,
      desc: "中国联通营业厅", tags: ["通信"] },
    { name: "中国移动", category: "其他设施", lng: 114.39233, lat: 30.479473,
      desc: "中国移动营业厅", tags: ["通信"] },
    { name: "中国电信", category: "其他设施", lng: 114.390622, lat: 30.479934,
      desc: "中国电信营业厅", tags: ["通信"] },
];
...
function isDesktop() {
    ...
    if (/Mobile|Android|iPhone|iPad|iPod|webOS/i.test(ua)) return false;
    return true;
}
...
function showToast(msg, duration) {
    ...
    if (!el) {
        ...
        el.id = 'toastMsg';
        el.style.cssText = 'position:fixed;top:60px;left:50%;transform:translateX(-50%);background:#333;color:#fff;padding:10px 24px;border-radius:8px;font-size:14px;z-index:9999;pointer-events:none;transition:opacity 0.3s;opacity:0;max-width:90vw;text-align:center';
